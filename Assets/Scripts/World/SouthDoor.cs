...
public class SouthDoor : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isLocked &&
            ...
            && generator.finalRoomInfoArray[generator.currentRoom].entranceDir == 0)
            || (generator.currentRoom < (easyMode ? 33 : 27) && generator.finalRoomInfoArray[generator.currentRoom].exitDir == 0))
            && enemyCount == 0)
        {
            isLocked = false;
            Unlock();
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        if (iHopeThisWorks)
        {
                ...
                && generator.currentRoom < (easyMode ? 33 : 27))
            {
                ...
                && !movement.transitioning && generator.currentRoom > 0)
            {
